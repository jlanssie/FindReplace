param (
    [string]$FindS = "", #Find this default string
    [string]$ReplaceS = "" #Replace this default string
)

#You can write the find and replacements strings directly into you command line.
#e.g.: C:\YOURPATH\FindReplace.ps1 -FindS "StringToFind" -ReplaceS "StringtoReplace"

#Important: Do not replace or delete the param block, it will break the code

$folderPath = "C:\YOURPATH\" #supports multi-folders: "C:\fso1*", "C:\fso2*"
$fileType = "*.docx"
